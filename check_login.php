	...
	else 
	{
		...
		//ถ้าค่ามีมากกว่า 0 ขึ้นไป ให้ดึงข้อมูลออกมาทั้งหมด
			...
			{                          //ตรวจสอบสถานะของผู้ใช้ว่าเป็น Admin
				...
				$_SESSION[ses_idUser] = session_id();            //สร้าง session สำหรับเก็บค่า ID
			...
			else($data[status_user]==user)
			{                              //ตรวจสอบสถานะของผู้ใช้งานว่าเป็น user
				$_SESSION[ses_idUser] = session_id();                      //สร้าง session สำหรับให้ User นำไปใช้งาน
